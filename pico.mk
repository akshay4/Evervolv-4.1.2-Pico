...
# Prebuilt Modules
PRODUCT_COPY_FILES += \
    device/htc/pico/prebuilt/modules/bcmdhd.ko:system/lib/modules/bcmdhd.ko \
    device/htc/pico/prebuilt/modules/kineto_gan.ko:system/lib/modules/kineto_gan.ko \
    device/htc/pico/prebuilt/modules/cifs.ko:system/lib/modules/cifs.ko \
    device/htc/pico/prebuilt/modules/tun.ko:system/lib/modules/tun.ko \
...
# RIL
PRODUCT_COPY_FILES += \
    device/htc/pico/prebuilt/ril/libhtc_ril.so:system/lib/libhtc_ril.so \
    device/htc/pico/prebuilt/ril/libril.so:system/lib/libril.so \
    device/htc/pico/prebuilt/ril/libreference-ril.so:system/lib/rilreference-ril.so \
...
# Credits app
PRODUCT_COPY_FILES += \
	device/htc/pico/prebuilt/app/Credits.apk:system/app/Credits.apk \
